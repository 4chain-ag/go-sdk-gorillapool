...
func (t *MockTransport) OnData(callback func(ctx context.Context, message *AuthMessage) error) error {
	t.messageHandler = callback
	return nil
}

func (t *MockTransport) GetRegisteredOnData() (func(ctx context.Context, message *AuthMessage) error, error) {
	t.mu.Lock()
	defer t.mu.Unlock()
